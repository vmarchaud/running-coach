...
router.post("/log", flowMiddleware("session_log_schedule"),  flowMiddleware("session_log_schedule"),  flowMiddleware("session_log_schedule"), async (c) => {
...
router.post("/schedule", flowMiddleware("session_log_schedule"),  flowMiddleware("session_log_schedule"),  flowMiddleware("session_log_schedule"), async (c) => {
  const body = await c.req.json<{
    name: string;
    sportId: number;
    dateStart: string;
